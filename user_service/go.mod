...
replace github.com/Fox520/away_backend/user_service/config => ./config
...
require (
	...
	github.com/Fox520/away_backend/user_service/config v0.0.0-00010101000000-000000000000
